...
{
	//Set the name of the Swimming Pool with the passed String SwimmingPool = mySwimmingPool;
}

void ALodging::SetLobbyArea(FString myLobbyArea)
{
	//Set the name of the Lobby Area with the passed String LobbyArea = myLobbyArea;
}
 
void ALodging::SetRooms(FString myRooms)
{
	//Set the name of the Rooms with the passed String Rooms = myRooms;
}

void ALodging::SetRestaurants(FString myRestaurants)
{
	//Set the name of the Restaurants with the passed String Restaurants = myRestaurants;
}
